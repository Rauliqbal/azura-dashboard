...
<template>
  <DefaultLayout>
    <div>
      ...
      <div class="mt-8">
        <div class="grid grid-cols lg:grid-cols-3 gap-8">
          <div class="card">
      ...
      <div class="flex flex-col mt-8">
        ...
        >
          <div
            class="inline-block min-w-full overflow-hidden align-middle border-b border-gray-200 shadow sm:rounded-lg lg:rounded-2xl"
          >
